...
INSERT INTO `bringme`.`PROVIDER` (`idProvider`, `providerFirstName`, `providerLastName`, `providerPhone`, `providerEmail`, `providerPassword`, `providerAddress`, `companyName`, `cityName`, `cityRegion`, `cityDepartement`, `providerRate`, `providerAnnulation`, `state`) VALUES (2, 'Jacques', 'Jardin', '9067842465', 'jardin@gmail.com', '', '76 avenue test', 'ematch', 'lille', 'cannes', '89', NULL, NULL, 0);
