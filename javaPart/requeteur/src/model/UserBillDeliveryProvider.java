...
public class UserBillDeliveryProvider {
    ...
    public static String[] getAllVariable() {
        ...
        Field[] fields= UserBillDeliveryProvider.class.getDeclaredFields();
